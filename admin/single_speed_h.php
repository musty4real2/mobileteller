  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        ...
        <div class="header">
           ...
           <center> <h1 class="page-title">SPEED PAY ORDER CONFIRMATION</h1></center>
        </div>
      <div class="container-fluid">
        <?Php
$set1=$object->fetchRecord($_GET['print'], "speedpay_history");
...
<div class="well">
    ...
    <table class="table">
       <center> <h3><b style="color:#F00;">Please print this page after each transaction</b></h3></center>
               <tr><td> 
        <label>Pin: </label>  <?php echo $st2['card_pin'];?>        </td>
        <td>
        <label>Serial Number:</label>
<?php echo $st2['card_serial'];?> </td></tr>
        
        
        <tr><td> <label>Date of Card Creation: </label> <?php echo $st2['card_creation_date'];?> </td><td>
        <label>Card Amount:</label>
<?php echo $st2['card_amount'];?> </td></tr>
        <tr><td>
        <label>Card Type:</label>
<?php echo $st2['card_type'];?>         </td></tr>
<tr><td colspan="2"><center>SENDER/RECIPIENT DATA.</center></td></tr>
    <tr><td>
        <label>Name of Recipient:</label>
<?php echo $st2['recipient_name'];?>         </td><td>
        <label>Recipient Account Number:</label>
<?php echo $st2['recipient_number'];?>         </td></tr>
<tr><td>
        <label>Sender phone_number:</label>
<?php echo $st2['senders_phone'];?>         </td><td>
        <label>Recipient Bank:</label>
<?php echo $st2['recipient_bank'];?>         </td></tr>
<tr><td colspan="2">
        <center><label>Date and Time of print out:</label>
<?php echo $st2['entry_date'];?>        </center> </td></tr>
        <tr>
        <td colspan="2">
