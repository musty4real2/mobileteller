  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Edit  Distributor Detail (s)</h1>
        </div>
                     <ul class="breadcrumb">
            ...
            <li><?php echo "<a href='viewdistributors.php?id={$_GET['id']}&noble=noble&thief=thief&noble=noble&thief=thief&noble=noble&thief=thief&noble=noble&thief=thief'>View Users</a>"; ?> </li>
        </ul>
...
if($phone_number==""){$error[]="Please specify Phone number";}
	if(!empty($error)){
		...
		elseif(empty($error)){
			...
			$sql=mysql_query("UPDATE `distributors` SET `name`='$name', `address`='$address', `phone_number`='$phone_number' WHERE `id`='{$_GET['editid']}' LIMIT 1");

			if($sql){
			
		header("location:viewdistributors.php?msg=User Record has been succesfully edited&id={$_GET['id']}&noble=noble&thief=thief&noble=noble&thief=thief&noble=noble&thief=thief&noble=noble&thief=thief");
			}
			else{
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">You are about to edit a distributor's profile</a></li>
      <li></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      ...
      <?php
	  $selectedit=$object->fetchRecord($_GET['editid'], "distributors");
