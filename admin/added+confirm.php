  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Smart Save Subcription Confirmation of Successful Registration</h1>
        </div>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#" data-toggle="tab">You Suscriber Registration was successful. Your Profile has been created </a></li>
      <li></li>
    </ul>
...
?></td><td colspan="2">
        <label></label><?php echo '<h1>'.$st2['title'].' '.$st2['surname'].' '. $st2['first_name'].' '. $st2['middle_name'].'</h1><br/> Suscriber Profile/ Registration Confirmation<br/>Please note You are expect to give a copy of these page to the suscriber';?><?php echo "<br/><b style='color:#F00;'>Mobile Teller Account Balance</b>  =<b>N </b>".$st2['balance'];?>
        </td></tr>
...
<?php
echo "
<a href=' http://www.edusoft.co/api/?user=mobile_teller&pass=28833&sender=Mobile Teller&recipients={$st2['phone_number']}&message=Dear+{$st2['surname']}+{$st2['first_name']}+{$st2['middle_name']}+your+Mobile+Teller+account+has+been+created.+Your+current+account+balance+is+{$st2['balance']}' target='_blank'>Send sms</a>"; ?>
</td></tr>
        <tr>
        <td colspan="2">
