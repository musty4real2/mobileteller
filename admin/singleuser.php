  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <li class="active">View a user  detail</li>
        </ul>
...
<div id="myTabContent" class="tab-content">
      ...
      <?php
	  $selectedit=$object->fetchRecord($_GET['userid'], "users");
while($row=mysql_fetch_array($selectedit)){

	  
	  ?>
          <button class="btn btn-primary"><i class="icon-save"></i> You are Viewing <?php echo " ". $row['name'];?>  Profile</button><br/><br/>
<table class="table">
<tr><td>
        <label>Name</label>
        
        </td><td><label><?php echo $row['name']; ?></label></td></tr>
        <tr>
        <Td><label>Address</label></td><td><label><?php echo $row['address']; ?></label></td></tr>
        <tr>
       <td> <label>phone Number</label></td><td><label><?php echo $row['phone_number']; ?></label></td></tr>
       <tr>
        <td><label>Username</label></td><td><label><?php echo $row['username']; ?></label></td></tr>
        <tr>
        <td>
        <label>Employee Department</label></td><td><label><?php echo $row['dept']; ?></label></td></tr>
        <tr>
        <td><label>Password</label></td><td><label><?php echo "<p>". $row['password']. "</p>"; ?></label>
        </td></tr>
