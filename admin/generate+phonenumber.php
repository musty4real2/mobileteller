  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        ...
        <div class="header">
            ...
            <h1 class="page-title">GENERATE ALL DISTINCT PHONE NUMBER</h1>
        </div>
            ...
            <li class="active">View All Phone Number</li>
        </ul>
...
<?php
$select="SELECT DISTINCT(`phone_number`) FROM `suscriber`";
$q=mysql_query($select);

if(mysql_num_rows($q)==0){ echo "<p class='msg warning'>Sorry, No phone numbers found!</p>";}
