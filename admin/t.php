...
<input type="submit" name="b" value="Generate card"/>
...
$rand1 = rand(100, 999); $rand2 = rand(100, 999);
...
$sn = mysql_query("SELECT `serial`,`pin`,`amount`,`entry_date`,`card_type` FROM `pin` WHERE `pin`='$pin2' AND `serial`='$serial2'");
