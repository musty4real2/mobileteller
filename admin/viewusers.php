  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">View All Users (Staff)</h1>
        </div>
...
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-save"></i> You are Viewing all created users as staff(s)</button>
  <div class="btn-group">
...
echo 'Do You Really Want To Delete these if you do it would not be available ? <a href="viewusers.php?yesdelete3='.$_GET['deleteid3'].'&id='.$_GET['id'].'">Yes </a>| <a href="viewusers.php?id='.$_GET['id'].'">No</a>';
exit();
...
if(isset($_GET['yesdelete3'])){
	...
	header("location:viewusers.php?id={$_GET['id']}");
	exit();
}
?>
<?php
...
?>
        <?php
		$get="SELECT * FROM `users` ORDER BY `id` DESC LIMIT $start, $display ";
...
<td><?php echo $l['phone_number'];?></td>
   ...
   <td><?php echo $l['dept'];?></td>
          <td>
                                      <?php echo "<a href='singleuser.php?userid=$rid&id={$_GET['id']}'><i class='icon-user'></i></a>"; ?>

                            <?php echo "<a href='editusers.php?editid=$rid&id={$_GET['id']}'><i class='icon-pencil'></i></a>"; ?>

              <?php echo "<a href='viewusers.php?deleteid3=$rid&id={$_GET['id']}'><i class='icon-remove'></i></a>"; ?>
          </td>
        </tr>
         <?php 
}
...
if ($current_page != 1) {
 echo '<center><a href="viewusers.php?s=' .
