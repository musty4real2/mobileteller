  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Create Card Distributor</h1>
        </div>
...
if($phone_number==""){$error[]="Please specify Phone number";}
	...
	if(!empty($error)){
		...
		elseif(empty($error)){
			...
			$sql=mysql_query("INSERT INTO `distributors` (`name`, `address`, `phone_number`, `staff_id`, `entry_date`) VALUES ('$name', '$address', '$phone_number', '{$_GET['id']}',NOW())");
		...
		header("location:admin_menu.php?msg=User has been succesfully created&id={$_GET['id']}&noble=noble&thief=thief&noble=noble&thief=thief&noble=noble&thief=thief&noble=noble&thief=thief");
				...
				echo "There was a proble inserting or creating these distibutor please check";
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">You are about to create a new card distributor</a></li>
      <li></li>
    </ul>
