  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        ...
        <div class="header">
            ...
            <h1 class="page-title">SEARCH FOR SPEED PAY PIN IN HISTORY</h1>
        </div>
...
?>
    <legend>Search for speed pay pin in History</legend>
...
$select="SELECT * FROM `speedpay_history` WHERE `card_pin`='{$_GET['wname']}'";
