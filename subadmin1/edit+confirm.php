  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        ...
        <div class="header">
            ...
            <center><h1 class="page-title">Subcription Updated  Successfully </h1></center>
        </div>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#" data-toggle="tab">You Suscriber Modificatios have been made  successfully. Your Suscriber Profile has been Updated </a></li>
      <li></li>
    </ul>
...
?></td><td colspan="2">
        <label></label><?php echo '<h1>'.$st2['title'].' '.$st2['surname'].' '. $st2['first_name'].' '. $st2['middle_name'].'</h1><br/> Suscriber Profile/ Registration Confirmation<br/>Please note You are expect to give a copy of these page to the suscriber';?>
        </td></tr>
