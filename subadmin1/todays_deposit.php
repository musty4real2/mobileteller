  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        ...
        <div class="header">
            ...
            <h1 class="page-title">View All Deposite MadeToday</h1>
        </div>
...
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-save"></i> You are Viewing all Deposit(s) Made Today</button>
  <div class="btn-group">
...
?>
        <?php
		$get="SELECT * FROM `deposite` WHERE `date`=CURDATE() ORDER BY `id` DESC LIMIT $start, $display ";
		$get=$object->query($get);
		if(mysql_num_rows($get)==0){ echo "<p style='margin:30px 0 30px 0; text-align:center; border:1px solid #CCC;'>No Deposite</p>";}
		
        
if(mysql_num_rows($get)>0){
?>
<h2>LIST OF ALL DEPOSIT AS AT <?php echo date("d").'   '; ?><?php echo date("M").'   '; ?><?php echo date("Y");?></h2>
    <table class="table">
      <thead>
        <tr>
          <th>#</th>
