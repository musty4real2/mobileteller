...
<option value="speed pay">Speed pay</option>
...
mysql_query("INSERT INTO pin (`serial`,`pin`,`amount`,`status`,`entry_date`,`card_type`) values ('$serial','$pin','$denominations','1',NOW(),'$cardtype')");
