...
?></td><td colspan="2">
      ...
      <br/> <a  title="withdraw from the balance in your account" onclick="return confirm('you do not have the authourisation for withdrawal please contact the overall adminisrtrator?')" href="<?php echo "#?id={$_GET['id']}&noble=noble&thief=thief&deposite={$_GET['confirmid']}&noble=noble&thief=thief&noble=noble&thief=thief&noble=noble&thief=thief";?>">Withdraw</a>
